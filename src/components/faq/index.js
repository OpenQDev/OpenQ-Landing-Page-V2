...
const listItems = [
  {
    ...
    description: `Head to https://app.openq.dev/ and click on "New Conntract." Paste in any GitHub Issue URL of an open repo (we plan to support private repos later on), then click on "Mint Contract" That's it! Just make sure you're using the Polygon network. `,
  },
  {
